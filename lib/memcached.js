...
, debug: false            // Output the commands and
};
...
(function(nMemcached){
  ...
  private.setters = function setters(type, validate, key, value, lifetime, callback, cas){
    ...
    if (value.length > memcached.maxValue) return private.errorResponse('The length of the value is greater than ' + memcached.maxValue, callback);
