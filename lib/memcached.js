...
Client.config = {
  ...
  , encoding: 'utf8'           // sentinel to prepend to all memcache keys for namespacing the entries
  , zlibInflate: false           // sentinel to prepend to all memcache keys for namespacing the entries
